...
export default function InstallPrompt() {
      ...
      >
        <div
          style={{
            ...
            padding: "24px 24px 40px", width: "100%", maxWidth: "min(100vw, 480px)",
            boxShadow: "0 -4px 24px rgba(0,0,0,0.15)",
          }}
          onClick={(e) => e.stopPropagation()}
        >
          <p style={{ fontSize: 18, fontWeight: 700, color: "#064E3B", fontFamily: "Nunito, sans-serif", textAlign: "center", marginBottom: 4 }}>
            {t("Install RationSmart")}
          </p>
          <p style={{ fontSize: 12, color: "#6D6D6D", fontFamily: "Nunito, sans-serif", textAlign: "center", margin: "0 0 20px" }}>
            {isIOS ? t("Add to your iPhone home screen in 3 quick steps") : t("Add to your Android home screen in 3 quick steps")}
          </p>
          {(isIOS
            ? [
                {
                  ...
                  desc: t('In Safari\'s bottom toolbar, tap the Share icon (square with an upward arrow).'),
                  icon: (
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                      <path d="M12 3v12M8 7l4-4 4 4" stroke="#1CA069" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-7" stroke="#1CA069" strokeWidth="2" strokeLinecap="round" />
                    </svg>
                  ),
                },
                {
                  ...
                  icon: (
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                      <rect x="4" y="4" width="16" height="16" rx="3" stroke="#1CA069" strokeWidth="2" />
                      <path d="M12 8v8M8 12h8" stroke="#1CA069" strokeWidth="2" strokeLinecap="round" />
                    </svg>
                  ),
                },
                {
                  n: 3,
                  title: t('Tap "Add"'),
                  desc: t('Confirm at the top-right — the RationSmart icon appears on your home screen.'),
                  icon: (
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                      <path d="M5 12l5 5L20 7" stroke="#1CA069" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  ),
                },
              ]
            : [
                { n: 1, title: t("Tap the ⋮ menu"), desc: t("Tap the three-dot menu button at the top-right of Chrome"), icon: null },
                { n: 2, title: t('"Add to Home screen"'), desc: t('Scroll and tap "Add to Home screen" in the menu'), icon: null },
                { n: 3, title: t('Tap "Add"'), desc: t('Confirm by tapping "Add" — the app icon appears on your home screen'), icon: null },
              ]
  ...
  return (
    ...
    >
      <div
        style={{
          width: "100%", maxWidth: "min(100vw, 480px)", padding: "0 12px 16px",
          pointerEvents: "auto",
        }}
      >
        <div
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <p style={{ color: "#fff", fontWeight: 700, fontSize: 14, fontFamily: "Nunito, sans-serif", margin: 0 }}>{t("Install RationSmart")}</p>
            <p style={{ color: "rgba(255,255,255,0.72)", fontSize: 11, fontFamily: "Nunito, sans-serif", margin: "2px 0 0" }}>{t("Add to home screen for app experience")}</p>
          </div>
          <button
            onClick={() => setVisible(false)}

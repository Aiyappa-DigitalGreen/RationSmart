      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 12, color: "#6D6D6D", fontFamily: "Nunito, sans-serif", textAlign: "center", margin: "0 0 20px" }}>
            {isIOS ? "Add to your iPhone home screen in 3 quick steps" : "Add to your Android home screen in 3 quick steps"}
          </p>
          {(isIOS
            ? [
                {
                  ...
                  desc: 'In Safari\'s bottom toolbar, tap the Share icon (square with an upward arrow).',
                  icon: (
                ...
                },
                {
                  ...
                  desc: 'Scroll the share sheet and tap "Add to Home Screen".',
                  icon: (
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                ...
                },
                {
                  n: 3,
                  title: 'Tap "Add"',
                  desc: 'Confirm at the top-right — the RationSmart icon appears on your home screen.',
                  icon: (
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
            ...
            : [
                { n: 1, title: "Tap the ⋮ menu", desc: "Tap the three-dot menu button at the top-right of Chrome", icon: null },
                { n: 2, title: '"Add to Home screen"', desc: 'Scroll and tap "Add to Home screen" in the menu', icon: null },
                { n: 3, title: 'Tap "Add"', desc: 'Confirm by tapping "Add" — the app icon appears on your home screen', icon: null },
              ]
